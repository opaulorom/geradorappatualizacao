        ...
        <div className={styles.tutorialContainer}>
            ...
            <article className={styles.tutorialSteps} >
                ...
                <section className={`${styles.step} ${styles.step4}`}>
                    ...
                    <img src="segundaparte.png"/>
                    <img src="tamanhonomefrase.png"/>
                    <br/>
                    <img src="quintaparte.png"/>
                </section>
